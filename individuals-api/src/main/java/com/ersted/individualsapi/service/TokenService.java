...
import com.ersted.individualsapi.dto.UserInfoResponse;
import com.ersted.individualsapi.utils.DateTimeUtils;
...
public class TokenService {
    ...
    @Observed(name = "tokenService.login")
    ...
    @Observed(name = "tokenService.refreshToken")
    public Mono<TokenResponse> refreshToken(String refreshToken) {
        return keycloakClient.refreshToken(refreshToken);
    }

    @Counted
    @Observed(name = "tokenService.getUserInfo")
